...
def clear_input_field():
    if st.session_state.user_question == "":
        ...
        st.session_state.input_timestamp = get_formatted_timestamp()
...
def main():
    ...
    if "input_timestamp" not in st.session_state:
        st.session_state.input_timestamp = None
        ...
        if uploaded_image:
            with st.spinner("Processing image..."):
                ...
                st.session_state.response_times.append({
                    'input_time': st.session_state.input_timestamp,
                    'response_time': get_formatted_timestamp(),
    ...
    if st.session_state.response_times:
        ...
        for timing in st.session_state.response_times:
            print(f"Input: {timing['input_time']}")
            print(f"Response: {timing['response_time']}")
            print(f"Processing Time: {timing['processing_time']}")
            print("----------------------------------------------")
